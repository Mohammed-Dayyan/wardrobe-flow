...
export async function unarchiveClothingItemAction(
  itemId: string,
  ...
  if (!existing.archived_at) {
    return { success: false, error: WARDROBE_ERRORS.NOT_ARCHIVED };
  }
  ...
  if (error) {
    console.error("unarchiveClothingItemAction:", error.message);
